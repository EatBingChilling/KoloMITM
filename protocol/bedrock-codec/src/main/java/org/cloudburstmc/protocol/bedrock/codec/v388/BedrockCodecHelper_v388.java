...
public class BedrockCodecHelper_v388 extends BedrockCodecHelper_v361 {
    ...
    public SerializedSkin readSkin(ByteBuf buffer) {
        ...
        ImageData skinData = this.readImage(buffer, encodingSettings.maxImageSize());
        ...
        ImageData capeData = this.readImage(buffer, encodingSettings.maxImageSize());
    ...
    public AnimationData readAnimationData(ByteBuf buffer) {
        ImageData image = this.readImage(buffer, encodingSettings.maxImageSize());
