...
public class PlayerSkinSerializer_v291 implements BedrockPacketSerializer<PlayerSkinPacket> {
    ...
    public void deserialize(ByteBuf buffer, BedrockCodecHelper helper, PlayerSkinPacket packet) {
        ...
        ImageData skinData = ImageData.of(helper.readByteArray(buffer, helper.getEncodingSettings().maxByteArraySize()));
        ImageData capeData = ImageData.of(64, 32, helper.readByteArray(buffer, helper.getEncodingSettings().maxByteArraySize()));
